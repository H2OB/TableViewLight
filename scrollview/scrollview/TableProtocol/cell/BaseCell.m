...
-(void)setDefaultView{
    ...
    _containerView.defaultColor=[UIColor whiteColor];
    _containerView.selectColor=[[UIColor lightGrayColor] colorWithAlphaComponent:.3];
...
-(void)setFrame:(CGRect)frame{
    ...
    self.line.frame=CGRectMake(0, _containerView.height-sizeFromPixel(1),_containerView.width , sizeFromPixel(1));
